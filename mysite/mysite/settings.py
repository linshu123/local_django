...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/linshu/Desktop/local_django/mysite/mysite/database_file',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '#z3h+h**s80vm+#y@ze=xw0_8en4fd7%2nh*=0t*_+c&amp;rfcd^i'
...
# For django_social_auth
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/login_facebook/'
